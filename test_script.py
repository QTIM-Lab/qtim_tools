...
# matrix = generate_rotation_affine(axis=0, rotation_degrees=45)

# print matrix

# new_numpy = apply_affine(input_numpy, matrix)

# save_numpy_2_nifti(new_numpy, load_test_file('sample_mri'), 'test.nii.gz')

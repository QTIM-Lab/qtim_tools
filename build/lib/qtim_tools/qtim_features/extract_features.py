...
def test_parallel():
    ...
    test_folder = 'C:/Users/abeers/Documents/Projects/Texture_Analysis_Class/'
    generate_feature_list_parallel(folder=test_folder, features=['GLCM','morphology', 'statistics'], labels=True, levels=100, outfile='test_feature_results_shape_parallel.csv',test=False, mask_value=0, erode=[0,0,0], overwrite=True, processes=2)
    return

...
def skull_strip(
    ...
    if method == "bet":
        ...
        extra_parameters["fsl_threshold"] = 0.5
        ...
        print(
            " ".join(
                [
                    ...
                    output_filename,
                    "-f",
                    str(extra_parameters["fsl_threshold"]),
                    "-g",
                    "0",
                    "-m",
                ]
        ...
        if temp_output or temp_mask_output:
            output, output_mask = convert_input_2_numpy(
                output_filename
            ), convert_input_2_numpy(output_mask_filename)
